...
| R20d.2 | Facilities — separation, treating, tanks, specs | ✅ R8 | 🟨 a separator and a header are in the loop and binding; treating, tanks and a real spec are not |

...
| **Design docs** | 24 design + 1 research + **26 phase docs**, 17 catalogue sheets + tech tree, 18 SDDs (000–017). Coherence log: **213 findings**, 61–213 from the code passes. **48 open SDD items of 62 raised** — all 62 registered below, verified against the SDDs rather than counted by hand. |

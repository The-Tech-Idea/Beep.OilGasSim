...
| **Design docs** | 24 design + 1 research + 25 phase docs, 17 catalogue sheets + tech tree, 18 SDDs (000–017). Coherence log: **147 findings**, 61–147 from the code passes. **49 open SDD items** now registered here rather than only in the documents that raised them. |

...
| R20d.5 | Transport — pipelines, berths, cargoes, custody transfer points | ✅ R11 | 🟨 **custody is a metered point and a flowline gathers to it.** The line's throughput-dependent drop is what makes commingling cost something (R6-V14, tested end to end) and its erosional velocity is a second constraint a player buys past. Berths, cargoes and export are not |

...
| 4 | **The chain (R20d.1–5)** — with **R12b.8 install** | 🟨 `IFlowSolver` over the registered network; separation, gas, water, transport; custody becomes a metered point. Closes FV1's 1000-tick half, R11-V13, SC7/SC8. An install template is catalogue work the moment a facility is something the loop routes through rather than around. **Proceeding gap by gap** — four design gaps sit between a well and a sale; three are closed (findings 157, 158, and the registry's own enumeration) and a manifold (159) is the next |
...
them surfaced within an hour of trying to make two modules touch. **A phase mark

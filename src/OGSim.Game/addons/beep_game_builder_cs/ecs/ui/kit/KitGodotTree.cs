...
namespace Beep.ECS.UI.Kit
{
    ...
    public partial class KitGodotTree : Tree
    {
        ...
        private void Apply()
        {
            ...
            AddThemeColorOverride("guide_color", new Color(ink.R, ink.G, ink.B, 0.22f));
            AddThemeColorOverride("relationship_line_color", new Color(ink.R, ink.G, ink.B, 0.38f));
            ...
            AddThemeConstantOverride("h_separation", Mathf.Max(5, fs / 2));
            AddThemeConstantOverride("v_separation", Mathf.Max(3, fs / 4));
            AddThemeConstantOverride("item_margin", Mathf.Max(6, fs / 2));
